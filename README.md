...
Array ini digunakan untuk menyimpan 10 nilai mahasiswa yang diinput user.

# 2. Screenshot hasil eksekusi
Pada program ini, 
array digunakan untuk menyimpan nilai 10 mahasiswa dan kemudian dilakukan proses:
...
# A. INPUT NILAI 10 MAHASISWA
# B. MENGHITUNG NILAI TERTINGGI, TERENDAH, RATA-RATA
# C. MENGHITUNG LULUS
# D. MENAMPILKAN GRAFIK NILALI
# E. MENAMPILKAN GRAFIK LULUS
